...
public class AnnotationTests
{
    ...
    public void Annotation_Inheritance_WorksCorrectly()
    {
        ...
        Assert.IsType<ArrowAnnotation>(arrow);
        Assert.IsType<RectangleAnnotation>(rect);
        Assert.IsType<MosaicAnnotation>(mosaic);
        Assert.IsType<TextAnnotation>(text);
        Assert.IsType<CropAnnotation>(crop);
