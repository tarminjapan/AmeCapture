...
| #   | 機能                         | 対応ソース                          | MVP必須  | 備考                 |
| --- | ---------------------------- | ----------------------------------- | -------- | -------------------- |
| S1  | グローバルホットキー         | `Services/GlobalShortcutService.cs` | **必須** | コア機能             |
| S2  | システムトレイ               | `Services/TrayService.cs`           | **必須** | バックグラウンド動作 |
| S3  | トレイメニューからキャプチャ | `Services/TrayService.cs`           | **必須** | S2の一部             |
